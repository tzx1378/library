...
<script>
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider', 'laytpl'], function () {
        ...
        table.render({
            elem: '#demo'
            , height: 550
            , url: '${pageContext.request.contextPath}/listDisBackBook?power=1' //数据接口
            , title: '图书表'
            , page: true
            , limit: 6
            , limits: [5, 10, 15, 20]
        ...
        function backBook(data1, obj, index) {
            $.ajax({
                url: '${pageContext.request.contextPath}/backBook?reader_id=' + data1.reader_id + '&book_id=' + data1.book_id,
                dataType: 'json',
                type: 'post',
