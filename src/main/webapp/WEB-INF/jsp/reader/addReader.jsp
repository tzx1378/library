...
<body>
<form class="layui-form" action="${pageContext.request.contextPath}/library/submitAddReader" method="post" id="addbook"
      lay-filter="example">
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                ...
                <input type="text" name="reader_id" value="${reader.reader_id}" lay-verify="required" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="card_state" lay-verify="required" value="${reader.card_state}"
