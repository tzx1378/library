...
<body>
<form class="layui-form" action="${pageContext.request.contextPath}/library/submitAddBook.action" method="post"
      id="addbook" lay-filter="example">
...
//            }
            ...
            $.ajax({
                url: '${pageContext.request.contextPath}/library/submitAddBook',
                data: data.field,
                dataType: 'json',
                type: 'post',
