...
<div class="login-main">
    ...
    <form class="layui-form" action="${pageContext.request.contextPath}/library/list.action" method="post">
        <div class="layui-input-inline">
            <input type="text" name="name" required lay-verify="required" placeholder="请输入姓名或账号" autocomplete="off"
                   class="layui-input">
        </div>
        <div class="layui-input-inline">
        ...
        <hr/>
        <p><a href="${pageContext.request.contextPath}/toRegister" class="fl">立即注册</a><a href="javascript:;"
                                                                                         onclick="forgetpsw();"
                                                                                         class="fr">忘记密码？</a></p>
    </form>
</div>
